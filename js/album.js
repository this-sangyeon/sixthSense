...
let trackArrayInfo = [
    ...
    },
    {
        ...
        // audio : 'img/media/Time of Our Life.mp3'
    },
    {
        title :'how to love',
        num : '3',
        ...
        // audio : 'img/media/How to love.mp3'
    },
    {
        title :'돌아갈래요',
        num : '4',
        ...
        // audio : 'img/media/Wanna Go Back.mp3'
    },
    {
        title :'포장',
        num : '5',
...
for(let i = 0; i < trackList.length; i++){
    trackList[i].addEventListener('click',(e)=>{
        ...
        for(let j = 0; j < trackList.length; j++){
            ...
            // trackMusic.innerText = trackArrayInfo[trackIndex].audio;
        }
